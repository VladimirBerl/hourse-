...
export const LOCATION_DATA: Record<string, Record<string, string[]>> = {
  "Россия": {
    ...
    "Московская область": ["Балашиха", "Подольск", "Химки", "Мытищи", "Королёв", "Люберцы", "Красногорск", "Электросталь", "Коломна", "Одинцово", "Домодедово", "Серпухов", "Щёлково", "Раменское", "Долгопрудный", "Жуковский", "Пушкино", "Реутов", "Сергиев Посад", "Воскресенск", "Лобня", "Клин", "Ивантеевка", "Дубна", "Егорьевск", "Чехов", "Дмитров", "Видное", "Ступино", "Павловский Посад", "Наро-Фоминск", "Фрязино", "Лыткарино", "Дзержинский", "Солнечногорск"],
  ...
  "Беларусь": {
    "Минская область": ["Минск", "Борисов", "Солигорск", "Молодечно", "Жодино", "Слуцк", "Дзержинск", "Вилейка", "Марьина Горка"],
