...
const CheckIcon = () => (
  <svg
    className="h-6 w-6 text-brand-accent mr-3 flex-shrink-0"
    ...
    <div className="bg-gray-50 min-h-screen font-sans">
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-sm shadow-sm transition-all">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <Link
            to="/login"
            className="px-5 py-2 bg-brand-primary text-white text-sm font-semibold rounded-lg hover:bg-brand-secondary transition duration-300 shadow-md"
          >
            Войти / Регистрация
          </Link>
        </div>
      ...
      <main>
        ...
        <section className="py-20" style={getBackgroundStyle(content.forWhomSectionBg)}>
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <AnimatedSection>
                <img
                  src={content.forTrainersImageUrl}
                  alt="Тренер с учеником"
              ...
              <AnimatedSection>
                <img
                  src={content.forStudentsImageUrl}
        ...
        <section className="py-20 text-center px-6 bg-white">
          <AnimatedSection>
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">{content.ctaSubtitle}</p>
            <Link
              to="/login"
              className="inline-block bg-brand-accent text-white font-bold text-lg px-8 py-4 rounded-lg shadow-lg hover:bg-green-600 transform hover:-translate-y-1 transition-all duration-300"
            >
